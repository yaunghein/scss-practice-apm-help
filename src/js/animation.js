...
// heroTl.from('.hero__button-2', { duration, y: 16, opacity: 0, ease }, '-=0.25');
heroTl.from('.hero__image-wrapper', { duration, scale: 0.8, opacity: 0, ease }, '-=0.8');
heroTl.from('.header__logo', { duration, y: 16, opacity: 0, ease, stagger: 0.1 }, '-=0.6');
heroTl.from('.header__link-item', { duration, y: 16, opacity: 0, ease, stagger: 0.05 }, '-=0.6');
